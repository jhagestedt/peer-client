...
import com.example.client.discovery.tuple.Pair;
        ...
        if (registrations != null) {
            registrations.forEach(registration -> {
                ...
                if (registry != null) {
                    ...
                    log.warn("corresponding client registry for registration {} not found.", registration);
                }
            });
        }
    }
